...
internal static class MarketAcquisitionClaimPersistence
{
        ...
        Configuration config)
    {
        ...
        return (
            new MarketAcquisitionClaimView
            {
                ...
                TargetBasis = MarketAcquisitionTargetBases.Normalize(stored.TargetBasis),
                MaximumOverage = stored.MaximumOverage,
        ...
        string? rejectIdempotencyKey)
    {
        config.ActiveMarketAcquisitionClaim = new PersistedMarketAcquisitionClaim
        {
            ...
            TargetBasis = MarketAcquisitionTargetBases.Normalize(claim.TargetBasis),
            MaximumOverage = claim.MaximumOverage,
