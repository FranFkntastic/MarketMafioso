...
public static class MarketAcquisitionRequestDocumentMapper
{
        ...
        DateTimeOffset? createdAtUtc = null)
    {
        ...
        var lines = document.Lines
            .Select((line, ordinal) => new MarketAcquisitionBatchLineView
            {
                ...
                TargetBasis = MarketAcquisitionTargetBases.Normalize(
                    line.TargetBasis,
                    document.ExactAcquisitionAuthority is not null),
                MaximumOverage = document.ExactAcquisitionAuthority is null ? line.MaximumOverage : 0,
        ...
        return new MarketAcquisitionClaimView
        {
            ...
            TargetBasis = first.TargetBasis,
            MaximumOverage = first.MaximumOverage,
    ...
    private static MarketAcquisitionBatchLineCreateRequest ToCreateLine(MarketAcquisitionRequestLineDocument line)
    {
        ...
        return new MarketAcquisitionBatchLineCreateRequest
        {
            ...
            TargetBasis = mode == "TargetQuantity"
                ? MarketAcquisitionTargetBases.Normalize(line.TargetBasis)
                : string.Empty,
            MaximumOverage = mode == "TargetQuantity" ? line.MaximumOverage : 0,
