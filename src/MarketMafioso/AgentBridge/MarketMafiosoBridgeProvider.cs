...
public sealed class MarketMafiosoBridgeProvider : IMarketMafiosoBridgeProvider
{
    ...
    [
        ...
        new("market-acquisition.compose", "Market Acquisition - Compose", "select-main-tab", "Market Acquisition/Compose", 61),
        new("market-acquisition.inbox", "Market Acquisition - Inbox", "select-main-tab", "Market Acquisition/Inbox", 62),
        new("market-acquisition.working-set", "Market Acquisition - Working Set", "select-main-tab", "Market Acquisition/Working Set", 63),
