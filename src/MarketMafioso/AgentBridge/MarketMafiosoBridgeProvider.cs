...
public sealed class MarketMafiosoBridgeProvider : IMarketMafiosoBridgeProvider
{
    ...
    [
        new("mmf.main-window", "MarketMafioso window", 10, IsDefault: true),
        new("mmf.main-window.compact", "MarketMafioso compact window", 20),
    ];
    ...
    [
        ...
        new("remote-market", "Remote Market", "select-main-tab", "Remote Market", 65),
    ];
        ...
        AgentBridgeUiReviewRegistry reviewRegistry)
    {
        ...
        this.openAcquisitionDiagnostics = openAcquisitionDiagnostics;
