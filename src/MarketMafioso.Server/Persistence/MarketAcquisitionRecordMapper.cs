...
internal static class MarketAcquisitionRecordMapper
{
    ...
    public static MarketAcquisitionBatchLineView ReadLineView(SqliteDataReader reader) =>
        new()
        {
            ...
            TargetBasis = reader.GetString(8),
            MaximumOverage = checked((uint)reader.GetInt64(9)),
            MaxQuantity = checked((uint)reader.GetInt64(10)),
            HqPolicy = reader.GetString(11),
            MaxUnitPrice = checked((uint)reader.GetInt64(12)),
            GilCap = checked((uint)reader.GetInt64(13)),
            Status = reader.GetString(14),
            PurchasedQuantity = checked((uint)reader.GetInt64(15)),
            SpentGil = checked((uint)reader.GetInt64(16)),
            LatestMessage = reader.IsDBNull(17) ? null : reader.GetString(17),
        };
