...
public sealed class ExactAcquisitionDryRunStartupRestorationTests
{
    ...
    public void PluginReload_RestoresRemainingDryRunIdempotentlyWithoutNetworkOrPurchase()
    {
        ...
        var store = new ConfigurationExactAcquisitionRouteExecutionStateStore(fixture.Config, () => fixture.SaveCount++);
        var persistedJson = fixture.Config.ExactAcquisitionRouteExecutionStateJson;
        ...
        using (var harness = MarketAcquisitionRouteEngineHarness.Create(store))
        {
            ...
            var contract = firstDocument.ExactAcquisitionAuthority!.FinalizedContract!;
            ...
            var activeLine = Assert.Single(active.ExactAcquisitionExecution!.Lines);
            ...
            Assert.Equal(RemainingListingGil, AgentBridgeRouteTruthProjection.ResolveActiveExactAcquisitionRemainingGil(active));
        ...
        Assert.Equal(1u, store.Restore()!.Lines.Single().PurchasedQuantity);
        Assert.Equal(PurchasedListingGil, store.Restore()!.TotalSpentGil);
        Assert.Equal(persistedJson, fixture.Config.ExactAcquisitionRouteExecutionStateJson);
    ...
    private static PersistedFixtureData PersistedFixture(bool dryRunOnly = true)
    {
        ...
        var document = ExactAcquisitionWorkbenchAuthorityService.Finalize(
        ...
        var receipt = draft with { ReceiptId = ExactAcquisitionDryRunExecutionStateRestorer.ComputeReceiptId(draft) };
        var state = new ExactAcquisitionRouteExecutionState(
        ...
        config.ExactAcquisitionRouteExecutionStateJson = Newtonsoft.Json.JsonConvert.SerializeObject(state);
        return new(config);
    }
    ...
    {
        var fixture = PersistedFixture();
        fixture.Config.ExactAcquisitionRouteExecutionStateJson = null;
